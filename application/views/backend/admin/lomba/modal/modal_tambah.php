                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback text-danger">Please choose a unique and valid nama lomba</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="gambar" name="gambar" required aria-describedby="inputGroupFileAddon01">
                                        <label class="custom-file-label" for="gambar">Choose file</label>
                                        <div class="invalid-tooltip">Please choose a unique and valid gambar</div>
